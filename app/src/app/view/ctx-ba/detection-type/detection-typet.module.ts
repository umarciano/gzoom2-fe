...
import { DetectionTypeComponent } from './detection-type.component';
import { GlFiscalTypeService } from 'app/api/service/gl-fiscal-type.service';
import { DetectionTypeResolver } from './detection-type-resolver.service';
...
@NgModule({
  ...
  providers: [
    GlFiscalTypeService,
    EnumerationService,
    DetectionTypeResolver,
    ConfirmationService,
    MessageService,
    CanDeactivateGuard
  ],
})
export class DetectionTypeModule { }
